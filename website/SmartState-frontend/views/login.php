...
<form class="form-signin" id="loginForm" action="/login" method="post">
    <h1 class="h3 mb-4 font-weight-normal logo"><a href="/">SmartState<br>Automation</a></h1>
    ...
    <div class="row">
        <div class="col-sm-12 mb-3 form-floating">
            <input type="text" name="user" id="inputEmail" style="pointer-events: auto;" class="form-control" placeholder="Username" required autofocus />
            <label for="inputEmail">Linkblue/Username</label>
        </div>
        <div class="col-sm-12 mb-3 form-floating">
